...
default accounts may have default passwords that need to be change

default configs for software can be insecure
...
careful with tools that can exploit server
...
**Containers** - cgroups, chroot, namespaces
